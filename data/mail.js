            ...
            <div class="compose-letter-scroll">
                <div class="compose-letter-wrap">
                    ...
                    <div class="compose-letter-inputs">
                        ...
                        <div class="compose-letter-body" style="font-family:${ff};font-size:${ptSize}">${mail.bodyIsHtml ? (mail.body || '') : escapeHtml(mail.body || '').replace(/\{\{name\}\}/g, escapeHtml((gameState && gameState.player && gameState.player.name) || '')).replace(/\n/g, '<br>')}</div>
                    </div>
                </div>
            </div>
        `;
